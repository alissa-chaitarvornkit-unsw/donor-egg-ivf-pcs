...
The documentation accompanies a study evaluating models of varying complexity and additional candidate predictors, with a focus on:

Predictive performance
Model stability and robustness
External validation and model transportability
Model interpretability and feature importance
Analytical and computational decisions throughout model development
Interactive PCS Documentation
